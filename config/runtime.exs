...
#
#     PHX_SERVER=true bin/sample_project start
#
...
if config_env() == :prod do
  ...
  config :sample_project, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  # Cloak vault key used to encrypt sensitive attributes at rest (e.g. the
  # Anthropic API key). Generate one with:
  #
  #     mix run -e 'IO.puts(Base.encode64(:crypto.strong_rand_bytes(32)))'
  #
  # Keep it stable: rotating it makes previously-encrypted values undecryptable.
  cloak_key =
